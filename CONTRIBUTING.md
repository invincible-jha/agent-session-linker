# Contributing to agent-session-linker

Thank you for contributing to agent-session-linker, part of the AumOS portfolio.
...
```bash
git clone https://github.com/aumos-ai/agent-session-linker.git
cd agent-session-linker
pip install -e ".[dev]"
```
