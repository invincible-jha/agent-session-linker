"""Comparison visualiser for agent-session-linker benchmark results."""
...
def main() -> None:
    ...
    print(f"\n{'=' * 80}")
    print("  agent-session-linker Benchmark Results")
    print(f"{'=' * 80}")
    ...
    print("    python benchmarks/bench_session_throughput.py")
    print("    python benchmarks/bench_session_latency.py")
